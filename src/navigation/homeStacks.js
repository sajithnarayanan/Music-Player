...
const HomeScreen = ({navigation}) => {
   ...
   <View>
        ...
        <Icon name="search" size={30} color="black"style={{top:-47,left:320}} onPress={()=>navigation.navigate('MainNav')} />
        <Icon name="card-giftcard" size={30} color="black"style={{top:-80,left:280}} onPress={()=>navigation.navigate('MainNav')} />
